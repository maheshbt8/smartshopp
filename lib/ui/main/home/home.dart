...
import 'package:fooddelivery/widget/ReviewsText.dart';
import 'package:fooddelivery/widget/basic/category.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _children(){
    ...
    for (var row in appSettings.rows){
      ...
      //
      if (row == "cat")
        skinHomeCategory(list, windowWidth, _onCategoriesClick);
      ...
      if (row == "pop"){
        list.add(Container(
          ...
          child: ListWithIcon(imageAsset: "assets/popular.png", text: strings.get(42),        // "Most Popular",
      ...
      if (row == "topf"){
        list.add(Container(
          color: appSettings.dishesTitleColor,
          padding: EdgeInsets.only(left: 10, right: 10, top: 10, bottom: 10),
          child: ListWithIcon(imageAsset: "assets/hot.png", text: strings.get(199),        // "Top Trends this week",
      ...
      if (row == "nearyou" && theme.multiple)
        skinHomeNearYourRestaurants(list, windowWidth, distanceForNearYourFilter,
            _onRestaurantClick, _onTopRestaurantNavigateIconClick, openFilterNearYourDistance);
      ...
      if (row == "review") {
        if (reviews.isNotEmpty)
          list.add(Container(
            ...
            child: ListWithIcon(imageAsset: "assets/reviews.png", text: strings.get(43),      // "Recent Reviews",
  ...
  openFilterNearYourDistance(){
    ...
    _dialogBody = Column(
      children: [
        Text(strings.get(309), style: theme.text14,),  // Select maximum distance:
        // SizedBox(height: 10,),
        Container(
          height: 200,
          ...
          children: <Widget>[
            Text(strings.get(133), style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),  // All
            Text("5 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("10 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("15 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("20 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("25 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),), // 5
            Text("50 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("100 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("150 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
            Text("200 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),), // 9
            Text("300 ${appSettings.distanceUnit}", style: TextStyle(color: theme.colorDefaultText, fontSize: 18),),
          ],
        ...
        Row(
          children: [
            ...
            Flexible(child: IButton3(
                ...
                pressButton: (){
                  switch(_selectitem){
                    case 0: distanceForNearYourFilter = 0; break;
                    case 1: distanceForNearYourFilter = 5; break;
                    case 2: distanceForNearYourFilter = 10; break;
                    case 3: distanceForNearYourFilter = 15; break;
                    case 4: distanceForNearYourFilter = 20; break;
                    case 5: distanceForNearYourFilter = 25; break;
                    case 6: distanceForNearYourFilter = 50; break;
                    case 7: distanceForNearYourFilter = 100; break;
                    case 8: distanceForNearYourFilter = 150; break;
                    case 9: distanceForNearYourFilter = 200; break;
                    case 10: distanceForNearYourFilter = 300; break;
                  }
                  setState(() {
                    _show = 0;
                  });
