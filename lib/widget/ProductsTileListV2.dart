...
class ProductsTileListV2 extends StatefulWidget {
  ...
  ProductsTileListV2({this.color = Colors.white, this.width = 100, this.height = 100,
    this.text = "", this.image = "", this.price = "",
    this.id = "", this.callback,
    this.text3 = "", this.onAddToCartClick,
    this.discountprice, this.discount, this.needAddToCart = true
  });
          ...
          child: Stack(
            children: [
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                      ...
                      child: ClipRRect(
                          borderRadius: new BorderRadius.only(bottomLeft: Radius.circular(appSettings.radius-2),
                              bottomRight: Radius.circular(appSettings.radius-2)),
                          child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(widget.text, style: theme.text18boldPrimaryUIWhite, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left,),
                            Row(
                              children: [
                                Expanded(child: Text(widget.text3, style: theme.text16UIWhite, overflow: TextOverflow.ellipsis, textAlign: TextAlign.start,)),
                                Text((widget.discountprice.isNotEmpty) ? widget.discountprice : widget.price, style: theme.text18boldPrimaryUIWhite, overflow: TextOverflow.ellipsis, textAlign: TextAlign.end,),
                              ],
                            ),
                            SizedBox(height: 5,)
                          ],
              ...
              if (widget.discountprice.isNotEmpty)
                saleSticker(widget.width, widget.discount, widget.discountprice, widget.price)
            ],
          ),
    ));
  }
