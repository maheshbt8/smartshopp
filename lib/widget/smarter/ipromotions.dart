...
class IPromotionSmart extends StatefulWidget {
  ...
  final int seconds;
  IPromotionSmart(this.dataPromotion, {this.width = 100, this.height = 100, this.colorGrey, this.colorActivy, this.style,
...
class _PromotionState extends State<IPromotionSmart> {
      ...
      children: <Widget>[
        Column(
          children: [
            ...
            Text(item.name, textAlign: TextAlign.start, style: widget.style,)
          ],
        )
