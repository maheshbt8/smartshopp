...
sHeaderWidget(var context, Function(String) callback, Color _color, String title){
  return _headerWidget2(context, callback, _color, title, _buttonBack(callback, _color));
}

sHeaderBackButtonWithBasket(var context, Function(String) callback, Color _color){
  return Container(
      height: 40,
...
sHeaderBackButton(var context, Color _color){
  return Container(
      height: 40,
      color: Colors.black.withAlpha(50),
      margin: EdgeInsets.only(top: MediaQuery.of(context).padding.top),
...
_buttonBack(Function(String) callback, Color _color){
  return Stack(
    children: <Widget>[
      Icon(Icons.arrow_back_outlined, color: _color,),
      Positioned.fill(
          child: Material(
              color: Colors.transparent,
              shape: CircleBorder(),
        ...
        child: Stack(
          children: <Widget>[
            Container(
              ...
              child: Icon(Icons.shopping_cart, color: _color,)
            ),
      ...
      child: Container(
        ...
        child: Stack(
          children: <Widget>[
            Container(
              alignment: Alignment.center,
              child: Icon(Icons.chat_bubble, color: _color,)
            ),
