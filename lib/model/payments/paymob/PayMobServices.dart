...
class PayMobServices {
  ...
  // 2 create order
  createOrder(String itemPrice, String orderId) async {
    _orderId = orderId;
    ...
    try {
      var response = await http.post(Uri.parse("https://accept.paymobsolutions.com/api/ecommerce/orders"),
          body: convert.jsonEncode({
            ...
            "currency": homeScreen.mainWindowData.payments.code, //"EGP",
  ...
  executePayment(String _integrationId, String _frame,
          ...
          String lastName, String userEmail, String phoneNumber) async {
    try {
